...
⚙️ Project Settings → Rendering - Clear coat enable second normal ✅ 
⚙️ Project Settings → Rendering - Reflection Capture Resolution 1024 or 2048 ✅   
⚙️ Project Settings → Rendering - Extend default luminance range in auto exposure settings ✅ 
⚙️ Project Settings → Rendering - Apply Pre-exposure before writing to the scene color ✅ 
...
> Project Settings → Rendering- G-Buffer Formet- High Precision Normal 👈
