...
tags:
  ...
  - Unreal
---
Mesh Distance Field는 공간을 부피 데이터로 저장하는 기술입니다.  
이 데이터를 머티리얼에서 직접 활용하면, 오브젝트 간의 거리 변화에 반응하는 다이내믹 효과를 구현할 수 있습니다.

이 글에서는 Distance Field 기반 인터랙티브 머티리얼 제작 과정을 다룹니다.

## 프로젝트 세팅

⚙️프로젝트 세팅 → `Mesh Distance field create` ✅ 
